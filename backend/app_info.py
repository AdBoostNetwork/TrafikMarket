...
def get_traffic_list(
        ...
        """
        Создаёт объект класса TrafficFilters и заполняет его полученными аргументами. После этого передаёт его в функцию БД, которая возвращает список объявлений.
...
def get_accs_list(
    ...
    """
    Создаёт объект класса AccsFilters и заполняет его полученными аргументами. После этого передаёт его в функцию БД, которая возвращает список объявлений.
